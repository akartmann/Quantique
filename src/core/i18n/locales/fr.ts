...
export const fr: Record<TranslationKey, string> = {
    ...
    // --- Registre des sources et des droits, rapport de revue généré (Story 3.3, FR26) -----------
    ...
    'ledger.blocker.accessibility-review-pending': 'La relecture d’accessibilité est en attente : {subject}',
    'ledger.blocker.accessible-controls-reference-pending': 'La référence des commandes accessibles est en attente : {subject}',
    ...
    'ledger.role.accessibilityReviewer': 'Relecteur d’accessibilité',
    ...
    'ledger.reviewer.reviewed': 'Validation enregistrée',
