...
export const fr: Record<TranslationKey, string> = {
    ...
    'lab.pattern.recorded': 'Observation enregistrée : {label} de {value} dans le résultat du modèle enregistré.',
    ...
    'experiment.result.fringeDisplacement': 'Déplacement des franges',
    ...
    // --- Registre des sources et des droits, route de revue `?ledger=1` (Story 3.3, FR26) --------
    'ledger.title': 'Registre des sources et des droits',
    'ledger.caseLine': '{title} · {id} · contenu du dossier {version}',
    'ledger.absent': '—',
    'ledger.decision.blocked': 'Autorisation de diffusion : BLOQUÉE. Ce dossier ne peut pas être diffusé publiquement tant que chaque ligne ci-dessous n’est pas levée.',
    'ledger.decision.clear': 'Autorisation de diffusion : accordée. Chaque source, chaque ressource et chaque rôle de relecture ci-dessous est levé.',
    ...
    'ledger.blocker.content-author-unrecorded': 'Aucun auteur du contenu n’est consigné pour ce dossier : {subject}',
    'ledger.blocker.scholarly-review-pending': 'L’examen scientifique des sources et des droits est en attente : {subject}',
    'ledger.blocker.educator-context-sheet-pending': 'La fiche de contexte pour les enseignants est en attente : {subject}',
    'ledger.sources.title': 'Sources',
    'ledger.assets.title': 'Ressources',
    'ledger.signOff.title': 'Validations',
    'ledger.references.title': 'Références',
    'ledger.column.source': 'Source',
    'ledger.column.asset': 'Ressource',
    'ledger.column.role': 'Rôle',
    'ledger.column.type': 'Type',
    'ledger.column.provenance': 'Provenance',
    'ledger.column.reference': 'Référence',
    'ledger.column.rights': 'Droits',
    'ledger.column.reviewer': 'Relecture',
    'ledger.column.claimOrUse': 'Usage revendiqué',
    'ledger.column.replacementPlan': 'Plan de remplacement',
    'ledger.column.citation': 'Référence bibliographique',
    'ledger.column.holder': 'Détenteur ou origine',
    'ledger.column.path': 'Chemin',
    'ledger.column.state': 'État',
    'ledger.column.name': 'Nom',
    'ledger.column.date': 'Date',
    'ledger.column.decision': 'Décision de référence',
    'ledger.role.primary': 'Primaire',
    'ledger.role.secondary': 'Secondaire',
    'ledger.role.contentAuthor': 'Auteur du contenu',
    'ledger.role.scholarlyReviewer': 'Relecteur scientifique',
    'ledger.role.accessibilityReviewer': 'Relecteur accessibilité',
    'ledger.role.educatorContextSheet': 'Fiche de contexte pour les enseignants',
    'ledger.role.accessibleControlsReference': 'Référence des commandes accessibles',
    'ledger.reviewer.reviewed': 'Validé',
    'ledger.reviewer.pending': 'En attente',
    'ledger.reviewer.de-scoped': 'Hors périmètre',
    ...
    'conclusion.missing.foreign-model-run': 'Épinglez des observations prises sur cet appareillage.',
    ...
    'print.observations.settings': 'Réglages de l’appareillage : {settings}.',
    ...
    'error.invalid-experiment-model-input': 'Les réglages choisis ne permettent pas de produire une mesure.',
    'error.unknown-experiment-model': 'Cette enquête désigne un modèle d’appareillage que cette version ne peut pas exécuter.',
